...
export default function Card() {
    ...
    const handleClickCard = (listId) => {
        navigate("/learn-vocabulary-card");
    }

    return (
        <div className="group overflow-hidden w-[32%] mt-5 mb-5 border-2">
            <img
            ...
            <div className=" border border-gray-100 bg-white p-3">
                ...
                <form className="mt-4 text-center flex flex-row flex-wrap justify-between">
                    <Button title=" Luyện tập" bg="bg-[#20a30f]" handleOnClick={() => handleClickPractice(22)} />
                    <Button title="Học flash card" bg="bg-yellow-500" handleOnClick={() => handleClickCard(22)} />
